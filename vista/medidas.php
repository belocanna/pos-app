<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Unidades de Medidas de Productos</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<div class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-8">
        <table class="table table-info table-borderless" id="tblMedidas">
          ...
          <div class="card border-primary">
            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <input type="text" name="nombreMedida" id="nombreMedida" class="form-control" placeholder="" aria-describedby="helpId">
              </div>
            </div>
...
<script>
  $(document).ready(function() {
    ...
    $("#btnGuardarMedida").on('click', function() {
      accion = 'registrar';
      var id = $("#idMedida").val(),
        nombre = $("#nombreMedida").val()
      var datos = new FormData();
      datos.append('id', id);
      ...
      Swal.fire({
        title: 'CONFIRMAR',
        text: 'Seguro desea registra la Unidad de Medida ?',
        icon: 'info',
        showCancelButton: true,
