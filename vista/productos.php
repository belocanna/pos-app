...
<div class="content">
  <div class="container-fluid">
    <div class="btn-agregar-laboratorio">
      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modalProductos" data-dismiss="modal">
        Agregar
      </button>
    </div>
    <br>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-info">
        <h5 class="modal-title" id="exampleModalLabel">Gestionar Producto</h5>
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="codigoProducto" id="codigoProducto" class="form-control" placeholder="Ingrese Codigo de Barras" required>
                </div>
                <div class="mb-2">
                  <label for="" class="form-label">Precio de Compra</label>
                  <input type="tel" name="precioCompra" id="precioCompra" class="form-control" placeholder="Ingrese Precio Compra" required>
                </div>
                <div class="mb-3">
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input type="text" name="nombreProducto" id="nombreProducto" class="form-control" placeholder="Ingrese Descripcion" required>
                </div>
                <div class="mb-2">
